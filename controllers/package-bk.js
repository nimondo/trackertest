...
exports.createPackage = handleAsync(async (req, res) => {
    const packageData = {
        _id: uuidv4(),
        ...req.body,
        customer_id: req.user._id, // Assuming user info is stored in req.user after authentication
    };
...
exports.getPackageById = handleAsync(async (req, res) => {
    ...
    if (packageData.active_delivery_id) {
        await packageData.active_delivery_id.populate('driver_id').execPopulate();
    }
